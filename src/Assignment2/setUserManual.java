...
public class setUserManual extends JFrame {
    ...
    setUserManual(){
        ...
        textArea.setText("Thank for using our system.\n\nThe user have to login the system before use. The username for " +
                ...
                "is admin and the password is 1234. Besides that, we also had give access to some important features to " +
                "to \nensure the user can use our system. However, there are some features is not suitable to be used in " +
                "current version. " +
